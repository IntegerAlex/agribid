...
import TeamMemberCardV2 from "./TeamMemberCardV2";
import AdvisoryMemberCardV2 from "./AdvisoryMemberCardV2";
...
const TeamV2 = () => {
  ...
  return (
    ...
    >
      {/* Founders Section - Ensured Uniform & Aligned Grid */}
      <section
        className="relative overflow-hidden px-6 py-20"
        aria-labelledby="founders-heading"
      >
        {/* Removing abstract background shapes for cleaner alignment */}
        {/* <div className="absolute inset-0 z-0 opacity-20">
          <div className="animate-float-slow absolute top-1/4 left-1/4 h-64 w-64 rounded-full bg-[rgba(var(--agriox-base-rgb),0.3)] blur-3xl delay-100"></div>
          <div className="animate-float-slow absolute right-1/4 bottom-1/4 h-80 w-80 rounded-full bg-[rgba(var(--agriox-primary-rgb),0.3)] blur-3xl delay-200"></div>
        </div> */}
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 items-stretch justify-items-center gap-6 md:grid-cols-2 lg:grid-cols-3">
            {" "}
            {/* Enforcing standard grid for equal cards */}
      ...
      {/* Advisory Board Section - Ensure consistent and aligned grid */}
      <section
        className="relative overflow-hidden bg-[linear-gradient(to_r,rgba(var(--agriox-secondary-rgb),0.05),rgba(var(--agriox-base-rgb),0.05),rgba(var(--agriox-primary-rgb),0.05))] px-6 py-20"
        aria-labelledby="advisory-heading"
      >
        {/* Removing abstract background shapes for cleaner alignment */}
        {/* <div className="absolute inset-0 z-0 opacity-20">
          <div className="animate-pulse-slow absolute top-1/4 right-1/4 h-72 w-72 rounded-full bg-[rgba(var(--agriox-secondary-rgb),0.3)] blur-3xl delay-100"></div>
        </div> */}
      ...
      {/* Consultants Section - Ensure consistent and aligned grid */}
      <section
        className="relative overflow-hidden px-16 py-20 xl:px-24"
        aria-labelledby="consultants-heading"
      >
        {/* Removing abstract background shapes for cleaner alignment */}
        {/* <div className="absolute inset-0 z-0 opacity-20">
          <div className="animate-float-slow absolute bottom-1/4 left-1/4 h-64 w-64 rounded-full bg-[rgba(var(--agriox-base-rgb),0.3)] blur-3xl delay-300"></div>
        </div> */}
        ...
        <div className="relative z-10 mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {consultants.map((consultant, index) => (
              <div
                key={index}
                className="animate-fade-in-up w-full min-w-0 flex-shrink-0 flex-grow transform transition-all duration-300 hover:scale-105"
                style={{ animationDelay: `${0.2 + index * 0.1}s` }}
              >
                <TeamMemberCardV2
