...
const FPCregistration = () => {
  ...
  const [formData, setFormData] = useState<FPCFormData>({
    fpcName: "",
    mobileNumber: "",
    registrationNumber: "",
    email: "",
  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-in-up-slow relative z-10 h-full w-full rounded-none bg-white/80 p-4 shadow-none backdrop-blur-sm">
        <HeroSection
          title="AGRIBID - FPC EMPANELMENT FORM"
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-2 text-left">
          {/* FPC Information Section */}
          <section
            aria-labelledby="fpc-info-heading"
          ...
          >
            ...
            <div>
              ...
              >
                Name of the FPC <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                id="fpcName"
                ...
                placeholder="Enter Name Of FPC"
                required
                aria-label="Name of the FPC"
...
export default FPCregistration;
