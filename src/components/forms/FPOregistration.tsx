  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-in-up-slow relative z-10 h-full w-full rounded-none bg-white/80 p-4 shadow-none backdrop-blur-sm">
        <HeroSection
          title="AGRIBID - FPO EMPANELMENT FORM"
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-2 text-left">
          {/* FPO Information Section */}
          <section
            aria-labelledby="fpo-info-heading"
          ...
          >
            ...
            <div>
              ...
              >
                Name of the FPO <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
                id="fpoName"
                ...
                placeholder="Enter Name Of FPO"
                required
                aria-label="Name of the FPO"
          ...
          <section
            ...
            className="grid grid-cols-1 gap-6 border-t border-gray-200 pt-4 md:grid-cols-2"
          >
            <h2
            ...
            <div>
              <label
                ...
                className="mb-1 block text-sm font-medium text-[var(--agriox-primary)]"
              >
                Bank Account Number (please fill again)
              </label>
              <input
                type="text"
              ...
              {Object.entries(commodityData).map(
                ([mainCommodity, subCommodities]) => (
                  <div key={mainCommodity}>
                    <label
                      htmlFor={`commodity-${mainCommodity}`}
                      className="mb-1 block text-sm font-medium text-[var(--agriox-primary)]"
                    >
                      {mainCommodity}
                    </label>
                    <select
                      id={`commodity-${mainCommodity}`}
                      name={mainCommodity}
                      value={formData.commoditySelections[mainCommodity] || ""}
                      onChange={(e) => handleCommodityChange(mainCommodity, e)}
                      aria-label={`${mainCommodity} Selection`}
                      className="w-full rounded-md border border-gray-300 p-3 text-gray-900 placeholder-[var(--agriox-primary)] transition duration-200 focus:border-[var(--agriox-primary)] focus:ring-[var(--agriox-primary)]"
                    >
                      <option value="">
                        {`-- Select ${mainCommodity} --`}
                      </option>
                      {subCommodities.map((sub, idx) => (
          ...
          <section
            ...
            className="grid grid-cols-1 border-t border-gray-200 pt-4"
          >
            <h2
            ...
            <div>
              ...
              <input
                ...
                className="text-gray-90 w-full rounded-md border border-gray-300 p-3 placeholder-[var(--agriox-primary)] transition duration-200 file:mr-4 file:rounded-md file:border-0 file:bg-[var(--agriox-primary)] file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-[var(--agriox-secondary)] focus:border-[var(--agriox-primary)] focus:ring-[var(--agriox-primary)]"
              />
            </div>
          </section>
